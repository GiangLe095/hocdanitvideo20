            ...
            {blogs && blogs.map((blog, idx) => (
              <tr key={blog.id}>
                ...
                <td style={{ border: "1px solid #ccc", padding: 8 }}>
                  ...
                  <button style={{ background: "#f44336", color: "#fff", border: "none", borderRadius: 4, padding: "4px 12px" }} onClick={() => handleDelete(blog.id, idx)} disabled={deletingId === blog.id}>{deletingId === blog.id ? "Đang xóa..." : "Delete"}</button>
                </td>
              </tr>
            ))}
          </tbody>
